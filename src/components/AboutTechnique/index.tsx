...
export function AboutTechnique(){
    return (
        <div className={styles.genericHtml}>
            <h1>A Técnica Pomodoro 🍅</h1>

            <div className={styles.aboutTechnique} >
                <p>
                ...
                <p>O objetivo é manter o foco total por um período curto e
                    garantir descansos para evitar o cansaço mental.</p>
            </div>
            ...
            <h2>
                Mas no <strong>My Pomodoro</strong> tem um diferencial!
            </h2>
            ...
            <p>
                ...
                descanso). <strong>Nosso padrão:</strong>
            </p><br />
            ...
            <ul>
                ...
                <li>🟢 Verde: Descanso longo (aparece a cada 8 ciclos).</li>
            </ul>
            ...
            <h2>Por que usar o My Pomodoro?</h2>
            <ul>
